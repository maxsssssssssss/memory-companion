...
export function createConfiguredVoiceprintService(
  store: JsonStore,
  providerOptions: { trainTimeoutMs?: number; maxRetries?: number } = {}
) {
  return new VoiceprintService(
    createConfiguredVoiceprintProvider(providerOptions),
